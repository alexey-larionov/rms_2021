...
# Function
# Takes two GRanges and a Dataframe with samples descriptions.  
...
combine_two_GRanges <- function(gr1, gr2, samples.df){
  ...
  # Clean-up & check
  #rm(gr1_chr, gr1_start, gr1_end, gr1_ref, gr1_alt, gr1_var_id)
  #gr1[,1:2]
  ...
  # Clean-up & check
  #rm(gr2_chr, gr2_start, gr2_end, gr2_ref, gr2_alt, gr2_var_id)
  #gr2[,1:2]
  ...
  # Clean-up
  #rm(intersect_gr1.gr, intersect_gr2.gr, stable_annotations)
  ...
  # Clean-up
  #rm(unique_gr1.gr, unique_gr2.gr, intersect_gr1_gr2.gr)
  ...
  # Clean-up
  #rm(samples.df, gr1_gr2, gt.mx, score.mx, metadata.ls)
